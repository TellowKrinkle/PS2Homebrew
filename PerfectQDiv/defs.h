...
#define VIF1_MSCAL(addr)    ((u32)(addr) | (0x14 << 24))
#define VIF1_UNPACK4X32(count, addr) ((0x6C << 24) | ((u32)(count) << 16) | (addr))
#define MAKE_U128(a, b, c, d) ((u128)(a) | ((u128)(b) << 32) | ((u128)(c) << 64) | ((u128)(d) << 96))